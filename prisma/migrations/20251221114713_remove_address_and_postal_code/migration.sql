/*
  ...
  - You are about to drop the column `address` on the `homes` table. All the data in the column will be lost.
  - You are about to drop the column `postalCode` on the `homes` table. All the data in the column will be lost.
...
INSERT INTO "new_homes" ("availableFrom", "bathrooms", "bedrooms", "city", "country", "createdAt", "description", "floor", "heating", "id", "key", "listingType", "ownerId", "pricePerMonth", "sizeSqMeters", "street", "title", "updatedAt", "yearBuilt", "yearRenovated") SELECT "availableFrom", "bathrooms", "bedrooms", "city", "country", "createdAt", "description", "floor", "heating", "id", "key", "listingType", "ownerId", "pricePerMonth", "sizeSqMeters", "street", "title", "updatedAt", "yearBuilt", "yearRenovated" FROM "homes";
DROP TABLE "homes";
